  ...
  <div class="frame">
      ...
      <div class="address follow">
        ...
        <div class="group">
          <a href="https://www.instagram.com/meraziitbh/">
            <div class="block-1">
              <img
                src="/assets/orbs_before_hover.svg"
                width="93px"
                class="image-6"
                alt="Instagram logo"
              />
              <img
                src="/assets/orb_insta_h.svg"
                width="93px"
                class="image-7"
                alt="Instagram logo"
              />
          ...
          <a href="https://www.youtube.com/@MerazIITBhilai">
            <div class="block-1">
              <img
                src="/assets/orb_yt.svg"
                width="93px"
                class="image-6"
                alt="YouTube Logo"
              />
              <img
                src="/assets/orb_yt_h.svg"
                width="93px"
                class="image-7"
                alt="YouTube Logo"
              />
          ...
          <a href="https://www.facebook.com/meraz.iitbh">
            <div class="block-1">
              <img
                src="/assets/orb_fb.svg"
                width="93px"
                class="image-6"
                alt="Facebook Logo"
              />
              <img
                src="/assets/orb_fb_h.svg"
                width="93px"
                class="image-7"
                alt="Facebook Logo"
              />
    ...
    <div class="nav">
      {#each links as { href, text }}
        <a {href} class="text-wrapper-3">{text}</a>
      {/each}
    </div>

    <div class="copyright">
      <h3 class="text-wrapper-6">
        Copyright @ Meraz 4.0 | <a href="/tnc">Terms and Conditions</a>
      </h3>
    </div>
  </div>
</footer>
