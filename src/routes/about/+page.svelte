  ...
  <div class="content">
    ...
    <div class="intro">
      ...
      <p>
        ...
        immerse your senses in an extravaganza which promises to not only paint
...
<style lang="scss">
  * {
  ...
  .content {
    ...
    position: relative;
    font-size: 3vh;
    font-family: "Libre Baskerville", serif; /* Apply Libre Baskerville to description text */
    text-align: center;
    line-height: 5vh;
  }
  ...
  .introheading {
    font-size: 5vh;
    font-family: "Libre Baskerville", serif; /* Apply Libre Baskerville to heading */
  }
